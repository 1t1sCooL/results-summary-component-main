                ...
                <div className='grid-flow'>
                    <div className='summary-item' data-item-type='accent-1'>
                        <div className='flex-group'>
                            ...
                            viewBox="0 0 20 20"><path stroke="#F55" 
                    ...
                    <div className='summary-item' data-item-type='accent-2'>
                        <div className='flex-group'>
                            ...
                            xmlns="http://www.w3.org/2000/svg" 
                            width="20" height="20" fill="none" 
                            viewBox="0 0 20 20"><path stroke="#FFB21E" 
                            stroke-linecap="round" stroke-linejoin="round" 
                            stroke-width="1.25" 
                            d="M5.833 11.667a2.5 2.5 0 1 0 .834 4.858"/>
                            <path stroke="#FFB21E" stroke-linecap="round" 
                    ...
                    <div className='summary-item' data-item-type='accent-3'>
                        <div className='flex-group'>
                            ...
                            width="20" height="20" fill="none" 
                            viewBox="0 0 20 20">
                            <path stroke="#00BB8F" stroke-linecap="round" 
                            stroke-linejoin="round" stroke-width="1.25" 
                    ...
                    <div className='summary-item' data-item-type='accent-4'>
                        <div className='flex-group'>
                            ...
                            width="20" height="20" fill="none" 
                            viewBox="0 0 20 20">
                            <path stroke="#1125D6" stroke-linecap="round" 
                            stroke-linejoin="round" stroke-width="1.25" 
